...
const HeroSection = () => {
  return (
    <SectionRevealer>
      <section>
        <h1 className="m-auto lg:text-8xl mt-16  font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-br from-yellow-200 to-sky-400 text-center drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)]">
